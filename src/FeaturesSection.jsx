...
const getFeatures = () => [
  {
    icon: (
      <svg width="24" height="24" fill="none" viewBox="0 0 24 24" className="text-primary">
        ...
        <path d="M2 12l10 5 10-5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" opacity="0.75"/>
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg width="24" height="24" fill="none" viewBox="0 0 24 24" className="text-primary">
        <path d="M2 12h4l3-9 6 18 3-9h4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
...
const FeaturesSection = () => {
  ...
  return (
    <section id="product" ref={ref} className="relative py-16 px-5 sm:py-20 sm:px-8 lg:py-[120px] lg:px-10">
      <div className="max-w-[1200px] mx-auto">
        ...
        >
          ...
          <p className="text-muted-foreground text-base sm:text-lg leading-relaxed max-w-[500px] mx-auto">
            {m.features_sub()}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {features.map((f, i) => (
            <div
              key={i}
              className="p-7 rounded-xl bg-card/30 border border-border cursor-default relative overflow-hidden hover:bg-card/50 hover:border-primary/15 transition-all duration-200"
              style={{
                opacity: visible ? 1 : 0,
                transform: visible ? 'translateY(0)' : 'translateY(20px)',
            ...
            >
              ...
              <div className="text-base font-semibold text-foreground mb-2 tracking-tight">{f.title}</div>
              <div className="text-sm text-muted-foreground/70 leading-relaxed">{f.desc}</div>
            </div>
          ))}
        </div>
      </div>
